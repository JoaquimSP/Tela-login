 ...
 */
package com.mycompany.testegui;
...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label1.setMinimumSize(new java.awt.Dimension(75, 19));
    ...
    private void BTNEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNEntrarActionPerformed
        // TODO add your handling code here: Joaquim 1234
        if(TXTUsuario.getText().equals("Joaquim") && TXTSenha.getText().equals("1234")){
         TelaHome tela = new TelaHome();
         tela.setVisible(true);
         this.dispose();
      } else 
        JOptionPane.showMessageDialog(null, "Usuário ou senha incorretos.","Info",JOptionPane.INFORMATION_MESSAGE);
